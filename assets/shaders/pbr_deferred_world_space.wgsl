...
fn main(in: VertexOutput) -> FragmentOutput {
	return FragmentOutput(
		vec4<f32>(in.world_space_fragment_location, 0.),
		vec4<f32>(in.world_space_normal, 0.),
		vec4<f32>(in.world_space_eye_location, 0.),
		vec4<f32>(in.world_space_light_location, 0.),
